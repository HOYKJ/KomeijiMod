...
public class TenkiYumeSpe extends AbstractWeatherPowers {
    public static final String POWER_ID = "TenkiYumeSpe";
    ...
    public TenkiYumeSpe(AbstractCreature owner) {
        this.name = NAME;
        this.ID = "TenkiYumeSpe";
        this.owner = owner;
        this.amount = 3;
        updateDescription();
