...
public class SoyukiSpe extends AbstractWeatherPowers {
    public static final String POWER_ID = "SoyukiSpe";
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings("Soyuki");
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
    private float[][] x = new float[18][20];
    private float[][] y = new float[18][20];
    private float[][] vX = new float[18][20];
    private float[][] vY = new float[18][20];
    private float[][] scale = new float[18][20];
    private float[][] scaleY = new float[18][20];
    private float[][] rotation = new float[18][20];
    private Color[][] rain = new Color[18][20];
    private Texture img2;

    public SoyukiSpe(AbstractCreature owner) {
        this.name = NAME;
        this.ID = "SoyukiSpe";
        this.owner = owner;
        this.amount = 5;
