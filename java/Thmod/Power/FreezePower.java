...
public class FreezePower extends AbstractPower {
    ...
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings("FreezePower");
    ...
    public FreezePower(AbstractCreature owner, int amount) {
        ...
        this.amount = amount;
        updateDescription();
        this.img = ImageMaster.loadImage("images/power/32/FreezePower.png");
    ...
    {
        AbstractDungeon.actionManager.addToBottom(new RemoveSpecificPowerAction(AbstractDungeon.player, AbstractDungeon.player, "FreezePower"));
    }
