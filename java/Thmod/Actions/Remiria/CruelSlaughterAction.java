...
public class CruelSlaughterAction extends AbstractGameAction
{
    private int[] damage;
    private boolean firstFrame;

    public CruelSlaughterAction(AbstractCreature source, int[] amount, DamageInfo.DamageType type, AttackEffect effect)
    {
    ...
    public void update()
    {
        ...
        if (this.isDone) {
            ...
            if(again){
                AbstractDungeon.actionManager.addToBottom(new CruelSlaughterAction(this.source, this.damage, this.damageType, this.attackEffect));
            }
