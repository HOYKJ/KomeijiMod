...
public class HakuEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vX;
    private float vY;
    ...
    public void initializeData(int i){
        ...
        this.vY = (MathUtils.random(-400.0F, -300.0F) * Settings.scale);
        ...
        this.vX = (MathUtils.random(-50.0F, 10.0F) * Settings.scale);
