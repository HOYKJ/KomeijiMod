...
public class RedFogCoverEffect extends AbstractGameEffect
{
    private float x;
    private float y;
    private float aV;
    ...
    public RedFogCoverEffect(int i)
    {
        ...
        float tmp = MathUtils.random(0.7F, 0.9F);
        this.color = new Color();
        this.color.r = tmp;
        this.color.g = (tmp - 0.18F);
        this.color.b = (tmp - 0.18F);
        this.scale = (MathUtils.random(16.0F, 30.0F) * Settings.scale);
        this.enemyAppear = (i == 0);
    }
