...
public class SeventeenAriticlesParticle extends AbstractGameEffect {
    ...
    public SeventeenAriticlesParticle(float sX, float sY, float tX, float tY, boolean facingLeft) {
        ...
        this.currentSpeed = 2000.0F * Settings.scale;
    ...
    private void updateMovement() {
        ...
        this.pos.sub(tmp);
        if (this.stopRotating) {
            this.currentSpeed += Gdx.graphics.getDeltaTime() * VELOCITY_RAMP_RATE * 6.0F;
        } else {
